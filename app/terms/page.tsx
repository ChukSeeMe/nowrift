  ...
  return (
    ...
    >
      ...
      <div>
        ...
        <h3 className="text-display-m text-off-white mt-6 mb-2">B. AI-Generated Summaries and Content Indexes</h3>
        <p className="text-body-l text-muted leading-relaxed mb-4">
          NowRift compiles, analyzes, and summarizes technical reports, developers&apos; newsletters, and industry events using artificial intelligence engines.
        </p>
        <ul className="list-disc pl-6 text-body-l text-muted leading-relaxed mb-4 space-y-2">
          ...
          <li>
            <strong className="text-off-white">Copyright of Summaries:</strong> The specific synthesized summaries, commentary, and compliance records generated by CRAM Services engines are copyrighted properties of NowRift. You may not scrape, reproduce, or republish these summaries in bulk without our express written permission.
          </li>
          <li>
